...
const CustomerList = ({ customers, currentPage, setCurrentPage, itemsPerPage, selectedCodes, totalPages, onCheckboxChange }) => {
    ...
    const { pushSelectedSku,selectedSku } = useUserStore();
    const prevHandler = () => {
    ...
    const columnDef = [
        { headerName: "Item Code", field: "item_code", sortable: true, checkboxSelection: true, headerCheckboxSelection: true },
